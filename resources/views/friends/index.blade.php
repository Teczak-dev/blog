        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="p-6">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 class="font-medium text-gray-900">
                                                    <a href="{{ route('users.profile', $friend) }}" class="hover:text-blue-600">
                                                        {{ $friend->name }}
                                                    </a>
                                                </h3>
                        ...
                        @else
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-500">Nie masz jeszcze znajomych.</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div id="pending-content" class="tab-content hidden">
                <div class="bg-white rounded-lg shadow">
                    <div class="p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4">Zaproszenia do znajomości</h2>
                                ...
                                @foreach($pendingRequests as $request)
                                    ...
                                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 class="font-medium text-gray-900">{{ $requester->name }}</h3>
                                                <p class="text-sm text-gray-500">{{ $requester->email }}</p>
                        ...
                        @else
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-500">Brak oczekujących zaproszeń.</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div id="sent-content" class="tab-content hidden">
                <div class="bg-white rounded-lg shadow">
                    <div class="p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4">Wysłane zaproszenia</h2>
                                ...
                                @foreach($sentRequests as $request)
                                    ...
                                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 class="font-medium text-gray-900">{{ $addressee->name }}</h3>
                                                <p class="text-sm text-gray-500">{{ $addressee->email }}</p>
                                                <p class="text-xs text-gray-400">
                                                    Wysłano {{ $request->created_at->diffForHumans() }}
                                                </p>
                                            </div>
                        ...
                        @else
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-500">Brak wysłanych zaproszeń.</p>
                            </div>
                        @endif
                    </div>
                </div>
